...
const ConnectFour = ({ socket, game, columns, rows, contiguousCountersToWin }: IConnectFourProps) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <ConnectFourGrid socket={socket} game={game} columns={columns} rows={rows} contiguousCountersToWin={contiguousCountersToWin} />
        </div>
    )
}
